# FS-UAE setup for version 1.3.1
...
floppy_drive_0 = /path/to/StuntCarRacer-Performance-v1.3.1.adf
```
...
| Patched ADF (1.3.1, 50 FPS Practice and computer-opponent races) | `a79adb7c6e7a40dc1bea260a86a67b1e7824c7c0302e24dd930a6455a47c1c71` |
